...
import openai_zero
from openai_zero import api_requestor, error, util
from openai_zero.openai_object import OpenAIObject
...
class APIResource(OpenAIObject):
    ...
    def instance_url(self, operation=None):
        ...
        api_version = self.api_version or openai_zero.api_version
        extn = quote_plus(id)
    ...
    def _get_api_type_and_version(
        ...
        typed_api_version = api_version or openai_zero.api_version
